...
// Lazy loading image
const loadObserve = function (entries, observer) {
  const [entry] = entries;
...
const imgObserver = new IntersectionObserver(loadObserve, {
  root: null,
  threshold: 0,
  rootMargin: '-200px',
});
...
const alertH1 = function (e) {
  alert('addEventListener: Great! You are raeding the heading :D');
};
...
//   alert('onmouseenter: Great! You are raeding the heading :D');
// };
*/
